...
float edgeFade(vec2 frag, vec2 res, vec2 offset, float n){
...
void main(){
    ...
    col *= edgeFade(frag, uResolution, uOffset, n);
    col *= uIntensity;
...
const PrismaticBurst = ({
  ...
  useEffect(() => {
    ...
    // Hard cap resolution at 1x to save massive fragment computation time
    const dpr = baseDpr > 1 ? 1 : 0.75;
